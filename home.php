        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-toggleable-sm navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <!-- Sanjog -->
                    <a href="http://localhost/admin0/admin/pages-login.html"><button type="button" class="btn btn-secondary btn-lg">LOGIN</button></a>
<a href="http://localhost/admin0/admin/thirdpage.php"><button type="button" class="btn btn-secondary btn-lg">SIGN UP</button></a>
                    <!-- ============================================================== -->
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                             <!--<a class="has-arrow waves-effect waves-dark" href="http://localhost/admin0/admin/thirdpage.php" aria-><i class="mdi mdi-gauge"></i><span class="hide-menu">HOME </span></a> -->
                            ...
                            <a href="http://localhost/admin0/admin/secondpage.php"><span class="hide-menu">HOME </span></a>
                        </li>
                        <li>
                          <!-- <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-laptop-windows"></i><span class="hide-menu">PARENT</span></a>
                            <ul aria-expanded="false" class="collapse">
                            ...
                            <a href="http://localhost/admin0/admin/parent.php"><span class="hide-menu">PARENT </span></a>
                        </li>
                        <li>
                            <!-- <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">CHILD</span></a>
                            <ul aria-expanded="false" class="collapse">
                            ...
                            <a href="http://localhost/admin0/admin/child.php"><span class="hide-menu">CHILD</span></a>
                        </li>
                        <li>
                            <!-- <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-email"></i><span class="hide-menu">SCHOOL</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="app-email.html">Mailbox</a></li>
                                <li><a href="app-email-detail.html">Mailbox Detail</a></li>
                                <li><a href="app-compose.html">Compose Mail</a></li>
                            </ul> -->
                            <a href="http://localhost/admin0/admin/secondpage .php"><span class="hide-menu">SCHOOL</span></a>
                        </li>
                        <!-- <li>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">SCHOOL</h3>
                        <ol class="breadcrumb">
