    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                  <div class="col-5">
                    <div class="card">
                        <div class="card-block">
                            <img src="Ronaldo.jpg" width="600px" height="360px"><br>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt
                              ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris
                               nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
                               cillum dolore eu fugiat nulla pariatur.
                              Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                              <!-- <br><button type="button" class="btn btn-primary"data-whatever="Submit">Select</button> -->
                              <a href="http://localhost/admin0/admin/thirdpage.php" target="_blank"><button type="button" name="button">Click Me</button></a>
                          </div>
                    </div>
                </div>
                <div class="col-5">
                  <div class="card">
                      <div class="card-block">
                          <img src="watch.jpg" width="600px" height="360px"><br>
                          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt
                            ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris
                             nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
                             cillum dolore eu fugiat nulla pariatur.
              ...
              <div class="col-5">
                <div class="card">
                    <div class="card-block">
                        <img src="shirt.jpeg" width="600px" height="360px"><br>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt
                          ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris
                           nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
                           cillum dolore eu fugiat nulla pariatur.
            ...
            <div class="col-5">
              <div class="card">
                  <div class="card-block">
                      <img src="C Master.png" width="600px" height="360px"><br>
                      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt
                        ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris
                         nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
                         cillum dolore eu fugiat nulla pariatur.
                    ...
                    <!-- <div class="col-11">
                        <div class="card">
                            <div class="card-block">
                              ...
                              <br>Re-Password =<input type ="Password" name="Password" required/><br>
                              <br><button type="button" class="btn btn-primary"data-whatever="Submit">Submit</button>
